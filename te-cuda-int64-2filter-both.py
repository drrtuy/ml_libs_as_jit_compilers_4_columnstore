...
bx1, tx1 = s[FIRST_FILTER_OUT].split(FIRST_FILTER_OUT.op.axis[0], factor=16)
bx2, tx2 = s[SEC_FILTER_OUT].split(SEC_FILTER_OUT.op.axis[0], factor=16)
bx3, tx3 = s[RID_OUT].split(RID_OUT.op.axis[0], factor=16)
